...
public class AddAndDeleteRecipe {
  ...
  @Test
  public void testAddAndDeleteRecipe() throws Exception {
    ...
    driver.findElement(By.id("title")).sendKeys("Chicken Salad");
    Thread.sleep(1500);
    driver.findElement(By.id("description")).click();
    driver.findElement(By.id("description")).clear();
    driver.findElement(By.id("description")).sendKeys("Tasty salad with chicken and ranch.");
    Thread.sleep(1500);
    driver.findElement(By.id("ingredients")).click();
    driver.findElement(By.id("ingredients")).clear();
    driver.findElement(By.id("ingredients")).sendKeys("chicken, ranch, lettuce.");
    Thread.sleep(1500);
    driver.findElement(By.id("instructions")).click();
    driver.findElement(By.id("instructions")).clear();
    driver.findElement(By.id("instructions")).sendKeys("mix it up!");
    Thread.sleep(1500);
    driver.findElement(By.id("calorieCount")).click();
    driver.findElement(By.id("calorieCount")).clear();
    driver.findElement(By.id("calorieCount")).sendKeys("349");
    Thread.sleep(1500);
